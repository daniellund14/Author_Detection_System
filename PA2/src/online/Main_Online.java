...
public class Main_Online {
    ...
    private static final String CONSTANT_ROOTSUM_PATH = "/PA2_Online_constant";
    private static final String ROOTSUM_PATH = "/PA2_Online_rootsum";
    private static final String NUMERATOR_PATH = "/PA2_Online_numerator";
    ...
    public static void main(String[] args) throws  IOException, InterruptedException, ClassNotFoundException{
        ...
        MRJob.job(conf, TFIDF_PATH, CONSTANT_ROOTSUM_PATH, RootSumMapper.class, RootSumReducer.class, Main_Online.class, true);
        MRJob.job(conf, OFFLINE_TFIDF_PATH, ROOTSUM_PATH, RootSumMapper.class, RootSumReducer.class, Main_Online.class, true);
        MRJob.job(conf, AAV_PATH, NUMERATOR_PATH, CosSimNumeratorMapper.class, CosSimNumeratorReducer.class, Main_Online.class, true);
